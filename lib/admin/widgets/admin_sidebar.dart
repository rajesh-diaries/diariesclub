...
class AdminSidebar extends ConsumerWidget {
  ...
  static const _items = <_NavItemSpec>[
    ...
    _NavItemSpec('/admin/workshops', 'Workshops', PhosphorIconsRegular.graduationCap, isStub: true),
    _NavItemSpec('/admin/catalog', 'Catalog', PhosphorIconsRegular.storefront, isStub: true),
    _NavItemSpec('/admin/config', 'Config', PhosphorIconsRegular.gear),
    _NavItemSpec('/admin/content', 'Content', PhosphorIconsRegular.fileText, isStub: true),
