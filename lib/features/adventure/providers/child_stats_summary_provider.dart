...
final childStatsSummaryProvider =
    FutureProvider.family<ChildStatsSummary, String>((ref, childId) async {
      ...
      if (sessionsCompleted > 0) {
        ...
        final since = firstCreated == null
            ? null
            : DateTime.tryParse(firstCreated)?.toLocal();
        if (since != null) {
