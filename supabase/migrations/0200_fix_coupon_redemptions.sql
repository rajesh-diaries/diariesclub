-- ===========================================================================
-- Migration 0200 — Remove non-existent order_id from coupon_redemptions insert
--
-- Migration 0199 recreated session_create and inserted into
-- coupon_redemptions with an `order_id` column, but the live table only has
-- session_id. This caused every session_create with a coupon (or Buddy
-- Discount) to fail with:
--   "column \"order_id\" of relation \"coupon_redemptions\" does not exist".
-- ===========================================================================
