-- Play Pass bug fixes + 1-hour-only restriction
--
-- 1. Add 'play_pass_purchase' to wallet_transactions.type enum
-- 2. Fix play_pass_purchase() wallet tx INSERT (balance_after_paise, no description)
-- 3. session_create: play_pass only allowed for 60-minute sessions

-- ===========================================================================
-- 1. Widen wallet_transactions.type enum to include play_pass_purchase
-- ===========================================================================
DO $$
BEGIN
  -- Recreate the check constraint to include 'play_pass_purchase'
...
-- ===========================================================================
-- 2. Fix play_pass_purchase() — proper wallet tx columns, no description
-- ===========================================================================
...
BEGIN
  ...
  -- Deduct from wallet with proper columns.
...
-- ===========================================================================
-- 3. session_create: play_pass only for 60-minute sessions
-- ===========================================================================
...
BEGIN
  ...
  ELSIF p_payment_method = 'play_pass' THEN
    -- Atomically redeem the soonest-expiring active pass.
