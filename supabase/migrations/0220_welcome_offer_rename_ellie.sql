-- Coupon codes were renamed to hero themes (data change applied via admin):
--   WELCOME100 -> ELLIE, 2KIDS -> ZENA, 3KIDS -> RAFI, 4KIDS -> GERRY,
--   5KIDS -> WILDPACK (discounts unchanged). Point welcome_offer_for_session at
--   the renamed first-session welcome coupon (ELLIE).
...
BEGIN
  ...
  -- First-session welcome coupon (formerly WELCOME100, now ELLIE).
