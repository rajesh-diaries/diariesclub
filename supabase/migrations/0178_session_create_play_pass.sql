-- ===========================================================================
-- Session creation: add 'play_pass' payment method support
--
-- When p_payment_method = 'play_pass', session_create atomically redeems
-- the family's soonest-expiring active pass and creates the session with
-- the full amount (for reporting) but no wallet deduction.
-- ===========================================================================
