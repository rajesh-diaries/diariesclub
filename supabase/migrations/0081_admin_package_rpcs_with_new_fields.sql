-- 0081 — admin_package_create + admin_package_update accept the new
-- columns (hall_name, min_guests, max_guests, price_per_pax_veg_paise,
-- price_per_pax_non_veg_paise, pdf_url) so the founder can author
-- packages from the admin form without hand-running SQL.
